...
def eval(val_file, model_path, data_args, model_args, training_args):
    ...
    for i, batch in enumerate(dataloader):
        ...
        # generated = model.generate(**batch, max_new_tokens=50, stopping_criteria=stopping_criteria, eos_token_id=603)
    ...
    print()
    save_txt((pred_answer, answers), f"{val_file}.{model_args.online}vec.manualy_check.txt")
...
if __name__ == '__main__':
    ...
    model_args_parser.add_argument('--online', default=10)
    ...
    val_files = [
        './data/triviaqa_dev_icl_template.txt.json',
    ]

    ckpt_prefix = '/mnt/nas-alinlp/zhuochen.zc/others/retrieval-infused-llm'
    model_paths = [

        f'{ckpt_prefix}/output/1130_triviaqa_bloomz1b_fullk_20vec_enc_dec/checkpoint-36000',
